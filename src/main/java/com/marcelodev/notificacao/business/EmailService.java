package com.marcelodev.notificacao.business;

import com.marcelodev.notificacao.business.dto.TarefaDTO;
import com.marcelodev.notificacao.infrastructure.exceptions.EmailException;
...
public class EmailService {
    ...
    public void enviaEmail(TarefaDTO dto) {
        ...
        try {
            ...
            MimeMessageHelper mimeMessageHelper = new MimeMessageHelper(messagem, true, StandardCharsets.UTF_8.name());
